#!/usr/bin/env python3
"""Synchronize Toki Codex review labels from current-head Codex reviews.

Adapted from the codex-lb review-label automation.
"""
...
TOKI_REQUIRED_CHECKS = frozenset(
    {
        "Build",
        "Linux Agent (Swift 5.9.2)",
        "Linux Hub (Swift 5.9.2)",
    }
)
REQUIRED_CHECKS_BY_REPO = {
    "choi138/toki": TOKI_REQUIRED_CHECKS,
}
PR_TIMELINE_QUERY = """
